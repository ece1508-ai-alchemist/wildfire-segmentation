...
def get_loader(data_set, is_train, loader_args):
    ...
    mean = [x / 10000 for x in [ 529.8350,  670.5348,  891.0950, 1077.3064, 1355.6924, 1803.6713,
        2002.1877, 2129.0054, 2197.2866, 2246.2820, 2313.7886, 1721.2771]]
    
    std = [x / 10000 for x in [ 662.8983,  705.7620,  733.9877,  836.4911,  847.7748,  837.1517,
         878.2544,  910.7749,  913.5588,  975.5820, 1125.1262,  961.8238]]
